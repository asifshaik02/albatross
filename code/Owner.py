...
class Owner:
    ...
    def gui(self):
        ...
        obj = Medicine()
        buttonasif = Button(frame2,text="getMidicine Details",command= obj.gui)
        buttonanil = Button(frame2,text="getBillTransaction",command= obj.gui)
        ...
        labele_name.grid(row=0,column=0)
        labele_nameq.grid(row=0,column=1)
        labele_phone.grid(row=1,column=0)
        labele_phoneq.grid(row=1,column=1)
        labele_role.grid(row=2,column=0)
        labele_roleq.grid(row=2,column=1)
        labelo_id.grid(row=3,column=0)
        labelo_idq.grid(row=3,column=1)
        root.mainloop()
        curr.close()
        conn.close()
Owner().gui()
